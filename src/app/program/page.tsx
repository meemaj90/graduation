...
export default function ProgramPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#0a1628 0%,#0d1f4c 50%,#0a1628 100%)', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '96px 16px 60px' }}>
      <Navigation />
      {/* Booklet */}

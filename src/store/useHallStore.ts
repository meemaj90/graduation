...
const defaultGraduates: HofGraduate[] = [
  // UKG → Year 1
  { id: 'g1', name: 'Phanuel', level: 'UKG → Year 1', subject: 'Literacy & Numeracy', photoUrl: demoPhoto('Phanuel'), dream: 'To become a doctor and help people', memory: 'Learning to read my very first book all by myself', teacherMsg: 'Phanuel is a shining star — always eager to learn and grow!', parentMsg: 'We are so proud of you Phanuel! Keep shining! 💛', honors: 'Star Reader Award' },
  ...
  { id: 'g8', name: 'Peter', level: 'Year 6 → Year 7', subject: 'History & Geography', photoUrl: demoPhoto('Peter'), dream: 'To be a journalist and travel the world reporting the truth', memory: 'Our class trip and writing a report that was published in the school newsletter', teacherMsg: 'Peter has a sharp analytical mind and a passion for truth. Watch out, world!', parentMsg: 'Peter, your voice matters more than you know. Keep going! 📰', honors: 'Young Journalist Award' },
  // Year 9 → Year 10
